<%--
    Document   : contact
    Created on : Jul 10, 2023, 12:55:37 PM
    Author     : ADMIN
--%>
            ...
            <div class="col-xl-9">
              <div class="contact-form-wrap" data-aos="fade-right">
                ...
                <div class="contact-form">
                  <form id="contact-form" action="submit-feedback" method="POST">
                    <div class="row row-gutter-20">
                        ...
                        <div class="form-group">
                          ...
                          <select name="staff" class="form-control" required="">
                            ...
                            <c:forEach items="${feedbacks}" var="feedback">
                              <option value="${feedback.staff_id}">${feedback.staff_name}</option>
                            </c:forEach>
                          </select>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <input class="form-control" type="email" name="email" value="${acc.getEmail()}">
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="form-group">
