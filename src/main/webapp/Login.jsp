    ...
    <section class="account-area">
      <div class="hero">
        ...
        <div class="login_form">
          ...
          <form class="input_box" action="login" method="post">

            <input type="text" class="field" placeholder="Account" name="username" value="">
            <input type="password" class="field" placeholder="Password" maxlength="10" name="password" value="">


            <a href="ForgotPassword.jsp" class="check_box">Forgot password</a>
