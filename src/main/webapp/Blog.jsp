...
<html lang="zxx">
    ...
    <head>
        ...
        <title>Blog :: Shome - Shoes eCommerce Website Template</title>
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <main class="main-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-header-content">
                                    ...
                                    <nav class="breadcrumb-area" data-aos="fade-down"
                ...
                <div id="addNewPostModal" class="modal">
                            ...
                            <div class="modal-body">
                                <form action="add-post" method="post">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button  style="background-color: #f44336; color: #fff; padding: 10px 20px; border: none; border-radius: 4px; font-size: 16px; color: white"type="submit" class="btn btn-warning">Post</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <section class="blog-area blog-inner-area">
                    ...
                    <div class="add-blog-btn">
                        ...
                        %>
                        <%
                            String FaildMessage = request.getParameter("FaildMessage");
                            if (FaildMessage != null && !FaildMessage.isEmpty()) {
                        %>
                        <script>
                            Toastify({
                                text: "<%= FaildMessage%>",
                        ...
                        <button class="btn-add-blog" 
                                style="background-color: #f44336; color: #fff; padding: 10px 20px; border: none; border-radius: 4px; font-size: 16px; float: right; margin-right: 200px; margin-top: 30px">
                            Add new Post</button>
                    </div>
                    <div class="container">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="post-item">
                                        <div class="inner-content">
                                            <div class="thumb">
                                                <a href="blog-details?blog_id=${blog.blog_id}"><img src="${blog.image}"
                                            ...
                                            <div class="content">
                                                <div class="meta-post">
                                                    <ul>
                                                        <li class="post-date"><i class="fa fa-calendar"></i>
                                                            ${blog.date_posted}</li>
                                                        <li class="author-info"><i class="fa fa-user"></i>
                                                            ${blog.authorName}</li>
                                                    </ul>
                                                </div>
                                                <h4 class="title">
                                                ...
                                                <c:if test="${user.id == blog.author_id}">
                                                    <button class="post-btn"data-post-id="${blog.blog_id}" onclick="confirmDelete(this)">Delete Post</button>
                                                </c:if>
                        ...
                        <div class="row">
                                    ...
                                    <div class="about-widget-wrap">
                                        <div class="widget-logo-area">
                                            <a href="index.html"> <img class="logo-main"
                                                                       src="assets/img/logo-light.webp" width="131" height="34"
                                                                       alt="Logo" />
                                            </a>
                                        </div>
                                        <p class="desc">Lorem ipsum dolor sit amet consl adipisi
                                            elit, sed do eiusmod templ incididunt ut labore</p>
                                        <div class="social-icons">
                                            <a href="https://www.facebook.com/" target="_blank"
                                               rel="noopener"><i class="fa fa-facebook"></i></a> <a
                                                href="https://dribbble.com/" target="_blank" rel="noopener"><i
                                                    class="fa fa-dribbble"></i></a> <a
                                                href="https://www.pinterest.com/" target="_blank"
                                                rel="noopener"><i class="fa fa-pinterest-p"></i></a> <a
                                                href="https://twitter.com/" target="_blank" rel="noopener"><i
                            ...
                            <div class="col-md-6 col-lg-3">
                                ...
                                <div class="widget-item widget-services-item">
                                    ...
                                    <h4 class="widget-collapsed-title collapsed"
                                        data-bs-toggle="collapse" data-bs-target="#widgetId-1">Services</h4>
                                        ...
                                        <div class="collapse-body">
                                            <div class="widget-menu-wrap">
                                                <ul class="nav-menu">
                                                    ...
                                                    <li><a href="contact.html">Professional
                                                            installation</a></li>
                            ...
                            <div class="col-md-6 col-lg-3">
                                ...
                                <div class="widget-item widget-account-item">
                                    ...
                                    <h4 class="widget-collapsed-title collapsed"
                                        data-bs-toggle="collapse" data-bs-target="#widgetId-2">My
                                        Account</h4>
                            ...
                            <div class="col-md-6 col-lg-3">
                                ...
                                <div class="widget-item">
                                    ...
                                    <h4 class="widget-collapsed-title collapsed"
                                        data-bs-toggle="collapse" data-bs-target="#widgetId-3">Contact
                                        Info</h4>
                    ...
                    <div class="container pt--0 pb--0">
                        <div class="row">
                            <div class="col-md-7 col-lg-6">
                                <p class="copyright">
                                    © 2021 Shome. Made with <i class="fa fa-heart"></i> by <a
                                        target="_blank"
                            ...
                            <div class="col-md-5 col-lg-6">
                                <div class="payment">
                                    <a href="account-login.html"><img
                                            src="assets/img/photos/payment-card.webp" width="192"
                                ...
                                <div class="content">
                                    ...
                                    <div class="quick-view-select">
                                        <div class="quick-view-select-item">
                                            <label for="forSize" class="form-label">Size:</label> <select
                                                class="form-select" id="forSize" required>
                                        ...
                                        <div class="quick-view-select-item">
                                            <label for="forColor" class="form-label">Color:</label> <select
                                                class="form-select" id="forColor" required>
            ...
            <div class="aside-cart-wrapper offcanvas offcanvas-end" tabindex="-1"
                ...
                <div class="offcanvas-body">
                    <ul class="aside-cart-product-list">
                        <li class="product-list-item"><a href="#/" class="remove">×</a>
                            <a href="single-product.html"> <img
                                    src="assets/img/shop/product-mini/1.webp" width="90" height="110"
                                    alt="Image-HasTech"> <span class="product-title">Leather
                                    Mens Slipper</span>
                            </a> <span class="product-price">1 × £69.99</span></li>
                        <li class="product-list-item"><a href="#/" class="remove">×</a>
                            <a href="single-product.html"> <img
                                    src="assets/img/shop/product-mini/2.webp" width="90" height="110"
                                    alt="Image-HasTech"> <span class="product-title">Quickiin
                                    Mens shoes</span>
                            </a> <span class="product-price">1 × £20.00</span></li>
                    </ul>
                    <p class="cart-total">
                        <span>Subtotal:</span><span class="amount">£89.99</span>
                    </p>
                    <a class="btn-theme" data-margin-bottom="10" href="shop-cart.html">View
                        cart</a> <a class="btn-theme" href="shop-checkout.html">Checkout</a> <a
                        class="d-block text-end lh-1" href="shop-checkout.html"><img
                            src="assets/img/photos/paypal.webp" width="133" height="26"
                            alt="Has-image"></a>
                </div>
            </div>
            <!--== End Aside Cart Menu ==-->
            ...
            <!--== Start Side Menu ==-->
            <div class="off-canvas-wrapper offcanvas offcanvas-start"
                ...
                <div class="offcanvas-body">
                    <div class="info-items">
                        <ul>
                            <li class="number"><a href="tel://0123456789"><i
                                        class="fa fa-phone"></i>+00 123 456 789</a></li>
                            ...
                            <li><a href="#">Shop</a>
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="#">Single Product</a>
                                        <ul class="sub-menu">
                                            <li><a href="single-normal-product.html">Single
                                                    Product Normal</a></li>
                                            <li><a href="single-product.html">Single Product
                                                    Variable</a></li>
                                            <li><a href="single-group-product.html">Single
                                                    Product Group</a></li>
                                            <li><a href="single-affiliate-product.html">Single
                            ...
                            <li><a href="#">Blog</a>
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="#">Single Blog</a>
                                        <ul class="sub-menu">
                                            <li><a href="blog-details-no-sidebar.html">Blog
                                                    Details</a></li>
                                            <li><a href="blog-details-left-sidebar.html">Blog
                                                    Details Left Sidebar</a></li>
                                            <li><a href="blog-details.html">Blog Details Right
                                                    Sidebar</a></li>
                                        </ul></li>
                                </ul></li>
                            <li><a href="contact.html">Contact</a></li>
        ...
        <script>
                            ...
                            var modal = document.getElementById("addNewPostModal");

                            // Get the button that opens the modal
                            var addPostButton = document.querySelector(".btn-add-blog");
                            ...
                            function deletePost(button) {
                                ...
                                xhr.open("POST", "delete-blog?blogId=" + encodeURIComponent(postId), true);
