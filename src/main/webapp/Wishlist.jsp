...
<%
    ...
    List<Products> WishListProduct = null;
    if (Wish_list != null) {
        DAO dao = new DAO(); // Khởi tạo đối tượng DAO
        try {
            WishListProduct = dao.getWishListProducts(Wish_list);
                    ...
                    <div class="col-md-12">
                        <div class="shopping-wishlist-table table-responsive">
                            <table class="table text-center">
                                ...
                                <%
                                    if (Wish_list != null) {
                                        for (Products p : WishListProduct) {
                                %>
                                <tr class="cart-wishlist-item">
                                    ...
                                    <td class="product-thumb">
                                        <a href="single-product.html">
                                            <img src="<%=p.getImage()%>" width="90" height="110" alt="Image-HasTech">
                                        </a>
                                    </td>
                                    <td class="product-name">
                                        <h4 class="title"><a href="single-product.html"><%=p.getName()%></a></h4>
                                    </td>
