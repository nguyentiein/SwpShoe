        ...
        <section class="account-area">
            <div class="hero">
                ...
                <div class="login_form">
                    ...
                    <form class="input_box" action="changepass" method="post">

                        <input type="text" class="field" name="username" placeholder="Name">
                        <input type="password" class="field" name="newpassword" placeholder="NewPassword" maxlength="10">
